...
class Subscription(Base, UUIDPrimaryKey, TimestampMixin):
    ...
    plan: Mapped[SubscriptionPlan] = mapped_column(
        Enum(SubscriptionPlan, native_enum=False), nullable=False, default=SubscriptionPlan.TRIAL
    )
    status: Mapped[SubscriptionStatus] = mapped_column(
        Enum(SubscriptionStatus, native_enum=False), nullable=False, default=SubscriptionStatus.TRIALING
    )
    ...
    # Bitmask tracking which trial lifecycle emails have been sent.
    # bit 0 = day3, bit 1 = day7, bit 2 = day12, bit 3 = trial_ended
